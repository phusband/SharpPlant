...
namespace SharpPlant.SharpPlantReview
{
    ...
    public class SprMeasurement
    {
        ...
        public SprPoint3D ActivePoint
        {
            get
            {
                return IsActive ? new SprPoint3D(DrMeasurement.Point) : null;
            }
            set
            {
                if (!IsActive) return;
        ...
        public SprPoint3D LastPoint
        {
            get
            {
                return IsActive ? new SprPoint3D(DrMeasurement.LastPoint) : null;
            }
            set
            {
                if (!IsActive) return;
        ...
        public SprPoint3D TextPoint
        {
            get
            {
                return IsActive ? new SprPoint3D(DrMeasurement.TextPoint) : null;
            }
            set
            {
                if (!IsActive) return;
